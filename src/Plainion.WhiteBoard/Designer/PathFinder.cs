...
{
    /// <summary>
    /// Calculates orthogonal connection path between two connectors.
    /// </summary>
    internal class PathFinder
    {
        private const int ConnectorMargin = 10;
        private const int PathMargin = ConnectorMargin - 5;
        ...
        private static Point GetNearestNeighborSource( ConnectorModel source, Point endPoint, Rect rectSource, Rect rectSink, out bool flag )
        {
